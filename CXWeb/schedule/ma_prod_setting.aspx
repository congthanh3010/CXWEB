<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="ma_prod_setting.aspx.cs" Inherits="CXWeb.schedule.ma_prod_setting" %>
            ...
            <tr>
                <td style="padding: 0px;">
                  ...
                  <%--  班次 Ca--%>
                    ...
                    機台產能-Công suất máy
                    <asp:TextBox ID="productivity"  Style="width: 70px;" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="padding: 0px;">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                           <%-- <asp:TemplateField HeaderText="Station ID" HeaderStyle-Width="100px">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Sta_No" runat="server" Text='<%# Eval("Sta_No") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txt_Sta_No" Width="100%" runat="server" ></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>--%>
                            <asp:TemplateField HeaderText="機台編號-Số máy" HeaderStyle-Width="100px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="機台產能-Công suất máy" HeaderStyle-Width="100px">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_productivity" Width="100%" runat="server" Text='<%# Eval("productivity") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lbl_productivity" runat="server" Text='<%# Eval("productivity") %>'></asp:Label>
                                </ItemTemplate>
                                 <FooterTemplate>
                                    <asp:TextBox ID="txtins_productivity" Width="100%" runat="server" ></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
