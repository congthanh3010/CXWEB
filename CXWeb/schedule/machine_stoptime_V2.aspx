<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="machine_stoptime_V2.aspx.cs" Inherits="CXWeb.schedule.machine_stoptime_V2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div style="position: absolute; width: 100%; height: 86%; overflow: auto;">
        ...
        <table class="table-bordered table-striped" style="width: 100%; font-size: large; padding: 0px; border: 0px;">
            ...
            <tr>
                <td style="text-align: left; background-color: #006699; color: white; font-weight: bold;" class="auto-style1">Machine Stop Time
                    </td>
            </tr>
                ...
                <table>
                     ...
                     <tr>
                        ...
                        <td colspan="2" class="auto-style2">
                            <asp:TextBox ID="txtBegin_Date" ClientIDMode="Static"   CssClass="some_class" runat="server"  Style="font-size: large;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="2" class="auto-style2">
                            <asp:TextBox ID="txtEnd_Date"  ClientIDMode="Static"   CssClass="some_class" runat="server"  Style="font-size: large;"></asp:TextBox>
                        </td>
                        </tr> 
                    <tr>
                        <td>
                            <asp:Label ID="lbtTime_Date" runat="server" Text="Time/Hours" Style="font-size: large;"></asp:Label>
                        </td>
                        <td colspan="2" class="auto-style2">
