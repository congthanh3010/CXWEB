<%@ Page Title="Ghi Chép Số Liệu Trạm Điện"Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="QA_Log.aspx.cs" Inherits="CXWeb.schedule.QA_Log" EnableEventValidation="false"  %>
                                ...
                                <div id="frmList" class="grvContainer">
                                    <asp:GridView ID="grvWLog" runat="server" CssClass="grvWLog" AutoGenerateColumns="false" BackColor="#CACBE1" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Code_Name"  ItemStyle-Width="250px" />
                                            <asp:BoundField DataField="Machine_Id"  ItemStyle-Width="80px" />
                                            <asp:BoundField DataField="Don_Vi"  ItemStyle-Width="80px" />
                                            <asp:BoundField DataField="Tieu_Chuan"  ItemStyle-Width="60px" />
