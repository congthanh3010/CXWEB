<%@ Page Title="Ghi Chép Số Liệu Nhiệt Độ QA"Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="QA_ND_Log.aspx.cs" Inherits="CXWeb.schedule.QA_ND_Log" EnableEventValidation="false"  %>
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: center; padding: 5px;">
                                            <div class="btn-group">
                                                ...
                                                <asp:Button ID="btnReoort" runat="server" Text="Báo cáo" Font-Bold="true" CssClass="btn btn-success"  OnClientClick="window.open('QA_ND_Log_Report.aspx','_newtab'); return false" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <div id="frmList" class="grvContainer">
                                    <asp:GridView ID="grvWLog" runat="server" CssClass="grvWLog" AutoGenerateColumns="false" BackColor="#CACBE1" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Nhiet_Ke_01" DataFormatString="{0:0}" ItemStyle-Width="80px" />
                                            <asp:BoundField DataField="Nhiet_Ke_TD_01" DataFormatString="{0:0}" ItemStyle-Width="80px" />
                                            
                                            <asp:BoundField DataField="Nhiet_Ke_02" DataFormatString="{0:0}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="Nhiet_Ke_TD_02" DataFormatString="{0:0}" ItemStyle-Width="80px" />
                                           
                                            <asp:BoundField DataField="Nhiet_Ke_03"  DataFormatString="{0:0}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="Nhiet_Ke_TD_03" DataFormatString="{0:0}" ItemStyle-Width="80px" />
                                            
                                            <asp:BoundField DataField="Nhiet_Ke_04"  DataFormatString="{0:0}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="Nhiet_Ke_TD_04" DataFormatString="{0:0}" ItemStyle-Width="80px" />
                                            
                                            <asp:BoundField DataField="Nhiet_Ke_05"  DataFormatString="{0:0}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="Nhiet_Ke_TD_05" DataFormatString="{0:0}" ItemStyle-Width="80px" />
                                            
                                            <asp:BoundField DataField="Nhiet_Ke_06"  DataFormatString="{0:0}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="Nhiet_Ke_TD_06" DataFormatString="{0:0}" ItemStyle-Width="80px" />
