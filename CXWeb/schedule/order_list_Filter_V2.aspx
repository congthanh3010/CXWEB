<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="order_list_Filter_V2.aspx.cs" Inherits="CXWeb.schedule.order_list_Filter_V2" %>
            ...
            <tr>
                <td style="padding: 0px;">
                  ...
                  <%--  班次 Ca--%>
                    ...
                    Ngày bắt đầu XL
                        <asp:TextBox ID="Start_Date"   ClientIDMode="Static"  Style="width: 100px;"  CssClass="some_class" runat="server"></asp:TextBox>
                     The total Qty to Merge
                        <asp:TextBox ID="txtQty_Merge"   ClientIDMode="Static"  Style="width: 100px;"  CssClass="some_class" runat="server"></asp:TextBox>                  
                </td>
            </tr>
            <tr>
                <td style="padding: 0px;">
                    ...
                    <asp:Button ID="btnExcel" runat="server" Style="font-size: large;" Text="Export Excel" OnClick="btnExcel_Click" Font-Bold="true"></asp:Button>
                    <asp:Button ID="Scheduling_Progress" runat="server" Style="font-size: large;" Text="Scheduling Progress" OnClick="btnOrder_Merge_Click" Font-Bold="true"></asp:Button>   
            ...
            <tr>
                <td style="padding: 0px;">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                             <asp:TemplateField HeaderText="Order Collection ID" HeaderStyle-Width="100px">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Order_ID" runat="server" Text='<%# Eval("Order_ID") %>'></asp:Label>
                                </ItemTemplate>                               
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Item No" HeaderStyle-Width="100px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Order ID" HeaderStyle-Width="100px">                               
                             ...
                             <asp:TemplateField HeaderText="Cus ID" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Cus_ID" runat="server" Text='<%# Eval("Cus_No") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Cus Name" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Cus_Name" runat="server" Text='<%# Eval("Cus_Name") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Delivery Date" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Delivery_Date_Convert" runat="server" Text='<%# Eval("Delivery_Date_Convert") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <%--<asp:TemplateField HeaderText="產品編號" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <%--<asp:Label ID="lbl_oeb04" runat="server" Text='<%# Eval("oeb04") %>'></asp:Label>--%>
                                     <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("link1") %>'
                                        Text='<%# Eval("oeb04") %>'></asp:HyperLink>
                                </ItemTemplate>                             
                            </asp:TemplateField>--%>
                             <asp:TemplateField HeaderText="Qty Order" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Qty_Convert" runat="server" Text='<%# Eval("Order_Qty_Convert") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Qty To Product" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Qty_To_Product" runat="server" Text='<%# Eval("Qty_To_Produce_Convert") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
            ...
            <tr>
                <td style="padding: 0px;">
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <RowStyle Font-Names="Calibri" Font-Size="18px" />
                        <Columns>
                             <asp:TemplateField HeaderText="Order Merging ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="交貨日期-Delivery Date" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDelivery_Date" runat="server" Text='<%# Eval("Delivery_Date_Convert") %>'></asp:Label>
                                    </ItemTemplate>

<HeaderStyle Width="100px"></HeaderStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="收訂量-Qty" HeaderStyle-Width="100px">
                                    <ItemTemplate>
