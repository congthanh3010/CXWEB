<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="order_list_filter.aspx.cs" Inherits="CXWeb.schedule.order_list_filter" %>
     ...
     <div style="position: absolute; width: 100%; height: 95%; overflow: auto;">
        ...
        <table class="table-bordered table-striped" style="width: 100%; font-size: large; padding: 0px; border: 0px;">
            ...
            <tr>
                <td style="padding: 0px;">
                  ...
                  <%--  班次 Ca--%>
                    ...
                    Item ID
                    <asp:TextBox ID="confirm_Item_ID"   ClientIDMode="Static"  Style="width: 200px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    Period/week
                    <asp:TextBox ID="txtWeek"   ClientIDMode="Static"  Style="width: 100px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    Total Quantity
                    <asp:TextBox ID="txtSum_Qty"   ClientIDMode="Static"  Style="width: 200px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    Total WIP
                    <asp:TextBox ID="txtSum_Wip"   ClientIDMode="Static"  Style="width: 200px;"  CssClass="some_class" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="padding: 0px;">
            ...
            <tr>
                ...
                <td style="padding: 0px;">
                   <div id='tab1' style="width: 100%; height: 80%; overflow: auto; top: 215px; left: 1px;">
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="訂單單號-Order ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="客戶-Cus ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCus_ID" runat="server" Text='<%# Eval("Cus_ID") %>'></asp:Label>
                                    </ItemTemplate>

<HeaderStyle Width="100px"></HeaderStyle>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="客戶簡稱-Cus Name" HeaderStyle-Width="100px">
                                    <ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                  ...
                                  <asp:TemplateField HeaderText="Qty to Produce" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_Pro" runat="server" Text='<%# Eval("Qty_Pro_Convert") %>'></asp:Label>
                                    </ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                     ...
                     <div id='tab2' style="width: 100%; height: 80%; overflow: auto;">
                         ...
                         <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Step Number" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol02" runat="server" Text='<%# Eval("Step_Nu") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Step ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol03" runat="server" Text='<%# Eval("Step_No") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Wip Qty" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcol04" runat="server" Text='<%# Eval("Wip_Qty_Convert") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
