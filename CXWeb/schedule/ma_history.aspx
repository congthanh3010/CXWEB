<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="ma_history.aspx.cs" Inherits="CXWeb.schedule.ma_history" %>
            ...
            <tr>
                <td style="padding: 0px;">
                  ...
                  <%--  班次 Ca--%>
                    ...
                    Machine ID
                    <asp:TextBox ID="confirm_Machine_ID"   ClientIDMode="Static"  Style="width: 300px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    Begin Date
                    <asp:TextBox ID="Begin_date"   ClientIDMode="Static"  Style="width: 100px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    End Date
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Machine ID" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lbl_oea03" runat="server" Text='<%# Eval("Machine_No") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Machine Qty" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lblQty_Machine_Convert" runat="server" Text='<%# Eval("Qty_Machine_Convert") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Produced Qty" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lblQty_Produced_Convert" runat="server" Text='<%# Eval("Qty_Produced_Convert") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Remaining Qty" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Description" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lblDecription" runat="server" Text='<%# Eval("Decription") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>                                          
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" runat="server" Text='<%# Eval("Qty_ProDuced") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Description" HeaderStyle-Width="100px">                               
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" runat="server" Text='<%# Eval("Decription") %>'></asp:Label>
                                </ItemTemplate>                             
                            </asp:TemplateField>   
                        </Columns>
                    </asp:GridView>
