<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="prod_Station.aspx.cs" Inherits="CXWeb.schedule.prod_Station" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Station ID" HeaderStyle-Width="100px">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_station_ID" runat="server" Text='<%# Eval("station_ID") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtins_station_ID" Width="100%" runat="server" ></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Productivity" HeaderStyle-Width="100px">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_productivity" Width="100%" runat="server" Text='<%# Eval("productivity") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lbl_productivity" runat="server" Text='<%# Eval("Qty_Convert") %>'></asp:Label>
                                </ItemTemplate>
                                 <FooterTemplate>
