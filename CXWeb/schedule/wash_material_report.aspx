<%@ Page Title="Bảng theo dõi sản xuất chuyền rửa liệu" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="wash_material_report.aspx.cs" Inherits="CXWeb.schedule.wash_material_report" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" id="frmContent">
        <div class="form-inline">
            ...
            <label for="ddlMachine">機台 (Chuyền rửa): </label>
        ...
        <div style="width: 100%;">
            <div style="background: #006699; text-align: center;">
                <asp:Label ID="lblTiltle" runat="server" Font-Bold="true" ForeColor="White" Font-Size="13" Text="洗线上料记录表<br/>GHI CHÉP THEO DÕI SẢN XUẤT CỦA CHUYỀN RỬA"></asp:Label>
            </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grvData" CssClass="grvData" runat="server" AutoGenerateColumns="false" ShowFooter="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MachineId" HeaderText="機台<br/>Mã chuyền rửa" HtmlEncode="false" HeaderStyle-Width="75px" ItemStyle-Width="75px" ItemStyle-VerticalAlign="Top" />
                                ...
                                <asp:BoundField DataField="RealWeight" HeaderText="重量 / kg<br/>Trọng lượng / kg" HtmlEncode="false" HeaderStyle-Width="95px" ItemStyle-Width="95px" />
                                <asp:BoundField DataField="Qty" HeaderText="數量 / PCS<br/>Số lượng / PCS" HtmlEncode="false" HeaderStyle-Width="70px" ItemStyle-Width="70px" />
                                <asp:BoundField DataField="ImportTime" HeaderText="進爐時間<br/>Thời gian vào phôi" HtmlEncode="false" DataFormatString="{0:HH:mm}" HeaderStyle-Width="75px" ItemStyle-Width="75px" />
                                <asp:BoundField DataField="Remark" HeaderText="備註<br/>Ghi chú" HtmlEncode="false" HeaderStyle-Width="200px" ItemStyle-Width="200px" />
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
