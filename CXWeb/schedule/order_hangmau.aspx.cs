...
{
    public partial class order_hangmau : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtBegin_Date.Text = DateTime.Now.AddDays(0).ToString("MM/dd/yyyy");
        ...
        void query()
        {
            ...
            myDatatable = myconn.ExecuteReturnDt("sp_MachineStopViewAll", htPara, CommandType.StoredProcedure);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string strsql = "sp_AddOrUpdateMachine";// sp_AddOrUpdateOrderSample
            myconn.myopen();
        ...
        protected void txtBegin_Date_TextChanged(object sender, EventArgs e)
        {
            try
            {
                DateTime dteBegin_Date = Convert.ToDateTime(txtBegin_Date.Text);
                ...
                if (intTotalDate < 0)
                    intTotalDate = 0;
                txtTime_Date.Text = Convert.ToString(intTotalDate);
            }
            catch (Exception)
            {
