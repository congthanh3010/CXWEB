<%@ Page Title="Ghi Chép Số Liệu Trạm Điện"Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="QA_Water.aspx.cs" Inherits="CXWeb.schedule.QA_Water" EnableEventValidation="false"  %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div id="frmTitle" style="background: #006699; text-align: center;">
                                <asp:Label ID="lblTitle" runat="server" Font-Bold="true" ForeColor="White" Text="IMPORT BẢNG KIỂM TRA ĐỘ DẪN ĐIỆN CỦA NƯỚC SAU XỬ LÝ"></asp:Label><BR />
                                <asp:Label ID="Label1" runat="server" Font-Bold="true" ForeColor="White" Text="導電度檢測表"></asp:Label>
                            </div>
                                ...
                                <div id="frmList" class="grvContainer">
                                    <asp:GridView ID="grvWLog" runat="server" CssClass="grvWLog" AutoGenerateColumns="false" BackColor="#CACBE1" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="XiLan_Time1" DataFormatString="{0:###,###.##}" ItemStyle-Width="80px" />
                                            <asp:BoundField DataField="XiLan_Time2" DataFormatString="{0:###,###.##}" ItemStyle-Width="80px" />
                                           
                                            <asp:BoundField DataField="XiTreo_Time1" DataFormatString="{0:###,###.##}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="XiTreo_Time2" DataFormatString="{0:###,###.##}" ItemStyle-Width="80px" />
                                            
                                            <asp:BoundField DataField="XiDen_Time1"  DataFormatString="{0:###,###.##}" ItemStyle-Width="85px" />
                                            <asp:BoundField DataField="XiDen_Time2" DataFormatString="{0:###,###.##}" ItemStyle-Width="80px" />
