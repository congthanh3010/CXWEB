<%@ Page Title="" Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="order_TrungCong.aspx.cs" Inherits="CXWeb.schedule.order_TrungCong" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div style="position: absolute; width: 100%; height: 86%; overflow: auto;">
        ...
        <table class="table-bordered table-striped" style="width: 100%; font-size: large; padding: 0px; border: 0px;">
            ...
            <tr>
                <td style="text-align: left; background-color: #006699; color: white; font-weight: bold;" class="auto-style1">Trùng công
                    </td>
            </tr>
