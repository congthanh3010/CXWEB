<%@ Page Language="C#" MasterPageFile="~/Site_schedule.Master" AutoEventWireup="true" CodeBehind="order_DBR.aspx.cs" Inherits="CXWeb.schedule.order_DBR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div style="position: absolute; width: 100%; height: 95%; overflow: auto;">
        ...
        <table class="table-bordered table-striped" style="width: 100%; font-size: large; padding: 0px; border: 0px;">
            ...
            <tr>
                <td style="padding: 0px;">
                  ...
                  <%--  班次 Ca--%>
                    ...
                    Order ID
                    <asp:TextBox ID="confirm_Order_ID"   ClientIDMode="Static"  Style="width: 300px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    Order Qty
                    <asp:TextBox ID="numOrder_Qty"   ClientIDMode="Static"  Style="width: 300px;"  CssClass="some_class" runat="server"></asp:TextBox>
                    Delivery Date
            ...
            <tr>
                <td style="padding: 0px;">
                    ...
                    <%--<asp:Button ID="btnSave" runat="server" Style="font-size: large;" Text="保存" OnClick="btnSave_Click" Font-Bold="true"></asp:Button>--%>
                     <asp:Button ID="btnReturn" runat="server" Style="font-size: large;" Text="返回/Back to home" OnClick="btnReturn_Click" Font-Bold="true"></asp:Button>
            ...
            <tr>
                <td style="padding: 0px;">
                    <%--<div id='tab1' style="position: absolute;width: 100%; height: 100%; overflow: auto; top: 215px; left: 1px;">--%>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="Date Input" HeaderStyle-Width="100px">
                                    <ItemTemplate>
...
<HeaderStyle Width="120px"></HeaderStyle>
                                 ...
                                 <asp:TemplateField HeaderText="Step BOM" HeaderStyle-Width="150px">
                                    <ItemTemplate>
...
<HeaderStyle Width="80px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="Station ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="Machine ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblOrder_Qty" runat="server" Text='<%# Eval("Machine_No") %>'></asp:Label>
                                    </ItemTemplate>

<HeaderStyle Width="100px"></HeaderStyle>
                                </asp:TemplateField>                        
                                <asp:TemplateField HeaderText="Order Qty" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_0" runat="server" Text='<%# Eval("Qty_0_Convert") %>'></asp:Label>
                                    </ItemTemplate>

<HeaderStyle Width="100px"></HeaderStyle>
                                </asp:TemplateField>
                            <asp:TemplateField HeaderText="Qty Machine/Day" HeaderStyle-Width="100px">
                                    <ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                            ...
                            <asp:TemplateField HeaderText="Qty Product" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_1" runat="server" Text='<%# Eval("Qty_1_Convert") %>'></asp:Label>
                                    </ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
         ...
         <tr>
            ...
            <tr>
                <td style="padding: 0px;">
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Item ID" HeaderStyle-Width="200px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblItem_No_1" runat="server" Text='<%# Eval("Item_No") %>'></asp:Label>

                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Machine ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblMachine_No_1" runat="server" Text='<%# Eval("Machine_No") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Step ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblStep_No_1" runat="server" Text='<%# Eval("Step_No") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="QTY" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_Convert_1" runat="server" Text='<%# Eval("Qty_Convert") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Begin Date" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBegin_Date_1" runat="server" Text='<%# Eval("Begin_Date") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="End Date" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEnd_Date_1" runat="server" Text='<%# Eval("End_Date") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
              ...
              <tr>
                <td style="padding: 0px;">
                          <asp:Button ID="btMPS" runat="server" Style="font-size: large;" Text="SAVE DBR" OnClick="btMPS_Click" Font-Bold="true"></asp:Button>
                ...
                <td style="padding: 0px;">
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                                <asp:TemplateField HeaderText="Date Input" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDate_Input2" runat="server" Text='<%# Eval("Date_Input") %>'></asp:Label>
                                    </ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="Order ID" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblOrder_Id2" runat="server" Text='<%# Eval("Machine_No") %>'></asp:Label>
                                    </ItemTemplate>
...
<HeaderStyle Width="100px"></HeaderStyle>
                                ...
                                <asp:TemplateField HeaderText="Qty Machine/ Day" HeaderStyle-Width="100px" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_Machine_Convert" runat="server" Text='<%# Eval("Qty_Machine_Convert") %>'></asp:Label>
                                    </ItemTemplate>

<HeaderStyle Width="100px"></HeaderStyle>
                                </asp:TemplateField>
                                
                                <asp:TemplateField HeaderText="Qty Produced" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_Produced_Convert" runat="server" Text='<%# Eval("Qty_Produced_Convert") %>'></asp:Label>
                                    </ItemTemplate>

<HeaderStyle Width="100px"></HeaderStyle>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Qty Remanining" HeaderStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQty_Rest_Convert" runat="server" Text='<%# Eval("Qty_Rest_Convert") %>'></asp:Label>
                                    </ItemTemplate>
