<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report28.aspx.cs" Inherits="CXWeb.sys.report28" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-md-12 main" style="padding: 0px;">
                <div class="wrap" style="height: 90px; padding: 0px;">
                    <div class="page-header">
                        ...
                        <div style="width: 100%; margin: auto; height: 60px;  top: 30px; position: absolute; background: #22324C;">
                            ...
                            <span style="margin-right: 15px; color: #C8DAF2; font-size: 13px;">起始時間 </span>
                            <asp:TextBox ID="textdate1" ClientIDMode="Static" Style="margin-right: 15px; width: 100px;" runat="server" CssClass="some_class"></asp:TextBox>

                            <span style="margin-right: 15px; color: #C8DAF2; font-size: 13px;">結束時間 </span>
                            <asp:TextBox ID="textdate2" ClientIDMode="Static" runat="server" CssClass="some_class" Style="width: 100px;"></asp:TextBox>

                            <span style="margin-right: 15px; color: #C8DAF2; font-size: 13px;">機種 </span>
                            <asp:TextBox ID="textprod" ClientIDMode="Static" runat="server" CssClass="some_class" Style="width: 100px;"></asp:TextBox>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <table class="table-bordered table-striped" style="width: 100%; margin-left: 0px" <%=code_hide_table%>>

                            <tr>

                                <td>
                                    <div style="width: 100%; height: 420px; overflow: auto; margin: auto;">
                                        <table class="table-bordered table-striped" style="width:1180px">
    ...
    <link href="/css/foundation-datepicker.css" rel="stylesheet" type="text/css" />
     <script type="text/javascript">
        ...
        $('#textdate1').fdatepicker({
            format: 'yy/mm/dd',
        });
        $('#textdate2').fdatepicker({
            format: 'yy/mm/dd',
        });
