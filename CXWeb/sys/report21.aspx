<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report21.aspx.cs" Inherits="CXWeb.sys.report21" %>
            ...
            <div class="col-md-12 main" style="padding: 0px;">
                <div class="wrap" style="height: 90px; padding: 0px;">
                    <div class="page-header">
                        <div style="position: absolute; width: 100%; height: 30px; background: #22324C;">
