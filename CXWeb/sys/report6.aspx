<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report6.aspx.cs" Inherits="CXWeb.sys.report6" %>
                ...
                <div class="wrap" style="height: 90px; padding: 0px;">
                    <div class="page-header">
                        ...
                        <div style="width: 100%; margin: auto; height: 60px;  top: 30px; position: absolute; background: #22324C;">
                            ...
                            <span style="margin-right: 15px; color: #C8DAF2;">工作站 </span>
                            <asp:TextBox ID="txtStation" ClientIDMode="Static" runat="server" CssClass="some_class"></asp:TextBox>

                            <span style="margin-right: 15px; color: #C8DAF2;">設備編號 </span>
                            <asp:TextBox ID="txtMachine" ClientIDMode="Static" runat="server" CssClass="some_class"></asp:TextBox>

                            <span style="margin-right: 15px; color: #C8DAF2;">設備名稱 </span>
                            <asp:TextBox ID="txtKV" ClientIDMode="Static" runat="server" CssClass="some_class"></asp:TextBox>
