<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report16.aspx.cs" Inherits="CXWeb.sys.report16" %>
                ...
                <div class="wrap" style="height: 90px; padding: 0px;">
                    <div class="page-header">
                        ...
                        <div style="width: 100%; margin: auto; height: 60px;  top: 30px; position: absolute; background: #22324C;">
                            ...
                            <span style="margin-right: 15px; color: #C8DAF2; font-size: 13px;">第一年: </span>
                            <asp:TextBox ID="textyear1" ClientIDMode="Static" Style="margin-right: 15px; width: 100px;" runat="server" CssClass="some_class"></asp:TextBox>

                            <span style="margin-right: 15px; color: #C8DAF2; font-size: 13px;">第二年: </span>
                            <asp:TextBox ID="textyear2" ClientIDMode="Static" runat="server" CssClass="some_class" Style="width: 100px;"></asp:TextBox>
                                ...
                                <td>
                                    <div style="width: 1180px; height: 420px; overflow: auto; margin: auto;">
                                        <table class="table-bordered table-striped" style="width:1180px">
                                            ...
                                            <thead>
                                                <tr>
                                                       <th colspan="6" style="width: 600px">年度採購統計</th>
                                                     <th colspan="3" style="width: 270px">年度最近一次議價</th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th style="width: 70px"><%= col_name[8] %></th>
                                                </tr>
                                            </thead>
