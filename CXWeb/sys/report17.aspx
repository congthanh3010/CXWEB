<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report17.aspx.cs" Inherits="CXWeb.sys.report17" %>
                        ...
                        <td>
                            <asp:Chart ID="Chart1" runat="server" Width="1200" Height="450" Palette="SeaGreen">
                                <Series>
                                    ...
                                    <asp:Series Name="Category3" ChartArea="ChartArea1" Font="Microsoft Sans Serif, 8.25pt, style=Bold">
                                    </asp:Series>
