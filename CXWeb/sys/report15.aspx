<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report15.aspx.cs" Inherits="CXWeb.sys.report15" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <table class="table-bordered table-striped" style="width: 1180px; margin-left: 0px" <%=code_hide_table%>>
                            ...
                            <tr>
                                <td>
                                    <div style="font-size: 15px; font-weight: bold;" > 模具維修原因百分比
                                    </div>
                                    <asp:Chart ID="Chart1" runat="server" Width="650" Height="450" Palette="SeaGreen">
                                        <Series>
                                ...
                                <td>
                                    <div style="width: 530px; height: 410px; overflow: auto; margin: auto;top:0px;">
                                        <table class="table-bordered table-striped" style="width: 530px;top:0px">

                                            <thead>

                                                <tr>
                                                    <th style="width: 230px"><%= col_name[0] %></th>
