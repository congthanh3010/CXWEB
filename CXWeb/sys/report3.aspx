<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report3.aspx.cs" Inherits="CXWeb.sys.report3" %>
    ...
    <div class="container-fluid report">
        <div class="row">
            ...
            <table class="table-bordered table-striped" style="width: 99%">
                 <tr>
                    <th colspan="2">Produce report
                    </th>
                </tr>
                <tr>
                    <th colspan="2">Time:
                <asp:Label ID="time" ClientIDMode="Static" runat="server" Text="---"></asp:Label>
                        <asp:HiddenField ClientIDMode="Static" ID="hvendor" runat="server" />

                    </th>
                </tr>
                <tr>
                    <th>Top 20 Product Quantity
                    </th>
                    <th>Production Detail
                    </th>
                ...
                <tr id="target">
                    <th colspan="2">Product:
                        <asp:Label ID="target_name" ClientIDMode="Static" runat="server" Text=""></asp:Label>
                    </th>
