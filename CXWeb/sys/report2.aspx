<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report2.aspx.cs" Inherits="CXWeb.sys.report2" %>
        ...
        <div class="row">
            ...
            <table class="table-bordered table-striped">
                ...
                <tr>
                 ...
                 <tr id="vendor">
                    <th colspan="2">Client:
                        <asp:Label ID="vendor_name" ClientIDMode="Static" runat="server" Text=""></asp:Label>
                    </th>          
