<%@Page EnableViewState="true" EnableEventValidation= "false " Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report11.aspx.cs" Inherits="CXWeb.sys.report11" %>
                    ...
                    <ContentTemplate>
                        ...
                        <table class="table-bordered table-striped" style="width: 1180px; margin-left: 0px" <%=code_hide_table%>>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="width: 400px; height: 410px; overflow: auto; margin: auto;top:0px;">
                                        <table class="table-bordered table-striped" style="width: 400px;top:0px">
