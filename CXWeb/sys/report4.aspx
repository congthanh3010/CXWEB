<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="report4.aspx.cs" Inherits="CXWeb.sys.report4" %>
                    ...
                    <td>
                        <div style="width: 400px; height: 400px; overflow: auto; margin: auto;">
                            <table class="table-bordered table-striped" style="width: 390px">
                               ...
                               <%-- <thead>
                                    <tr>
                                        <th style="width: 40%">Vender ID</th>
                    ...
                    <td>
                        <div style="width: 400px; height: 400px; overflow: auto; margin: auto;">
                            <table class="table-bordered table-striped" style="width: 390px">
                                ...
                                <thead>
                                    <tr>
                                        <th style="width: 40%">工单编号</th>
                                        <th style="width: 60%">报废重量</th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="Repeater3" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href=<%# Eval("url") %>><%# Eval("col1") %></a></td>
                                                <td><%# Eval("col2") %></td>
                ...
                <tr>
                 <%--   <td>
                        <table style="width: 99%">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Chart ID="Chart3" runat="server" Width="400" Height="400" Palette="SeaGreen">
                                        <Series>
                                            <asp:Series Name="Category" ChartArea="ChartArea1">
                                            </asp:Series>
                                        </Series>
                    ...
                    <td colspan="2" >
                        <div style="width: 100%; height: 400px; overflow: auto; margin: auto;">
                            <table class="table-bordered table-striped" style="width: 99%">

                                <thead>
                                    <tr>
                                         <th style="width: 20%">修模单据</th>
                                        <th style="width: 20%">模具编号</th>
                                        <th style="width: 20%">模具名称</th>
                                         <th style="width: 20%">大类保养</th>
                                        <th style="width: 20%">小类保养</th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="Repeater4" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%# Eval("tc_moeb01") %></td>
                                                <td><%# Eval("tc_moeb03") %></td>
                                                <td><%# Eval("tc_moa02") %></td>
                                                <td><%# Eval("tc_mod02") %></td>
                                                <td><%# Eval("tc_mod04") %></td>
