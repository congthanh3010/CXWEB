...
<body>
    <form id="form1" runat="server">
        <div class="container-fluid" style="margin-left: 20px; margin-right: 20px;">
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <asp:DropDownList CssClass="btn btn-primary" ClientIDMode="Static" ID="Dep" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Dep_SelectedIndexChanged">
                            <asp:ListItem Value="">1-toàn xưởng - CXVN</asp:ListItem>
                            <asp:ListItem Value="CT1">2-CT1 - 製一</asp:ListItem>
                            <asp:ListItem Value="CT2;CT21">3-CT2 - 製二單打</asp:ListItem>
                            <asp:ListItem Value="CT2_LH">4-CT2_LH - 製二連續</asp:ListItem>
                            <asp:ListItem Value="CT3;CT31">5-CT3 - 製三</asp:ListItem>
                            <asp:ListItem Value="CT3_LH">6-CT3_LH - 製三組連續沖壓</asp:ListItem>
                            <asp:ListItem Value="CNC1;CNC11">7-CNC1 - CNC一區</asp:ListItem>
                            <asp:ListItem Value="CNC2;CNC21">8-CNC2 - CNC二區</asp:ListItem>
                            <asp:ListItem Value="NC;NC1">9-NC - NC加工區</asp:ListItem>
                            <asp:ListItem Value="NC1">10-NC1 - NC加工區之二</asp:ListItem>
                            <asp:ListItem Value="DE">11-DE - 鋁製區</asp:ListItem>
                            <asp:ListItem Value="JA">12-JA - 精密沖壓</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="row" style="border: 1px solid; background-color: lightgray; margin-top: 10px;">
                        <div class="myDiagram" style="max-width: <%=max_width%>px; margin: auto; margin-top: 10px; margin-bottom: 10px;">
                            <telerik:RadDiagram ClientIDMode="Static" ID="brackets" runat="server" Selectable="false" EnableViewState="true" Editable="false">
            ...
            <div class="modal" id="clicker" role="dialog">
        ...
        function client_click(e) {
            ...
            if (e.item instanceof kendo.dataviz.diagram.Shape) {
                if (id.substr(0, 2) == "mc") {
                    ...
                    //$.ajax({
                    //    method: "POST",
                    //    url: "/plc/machine_work.aspx/GetMachineWork",
