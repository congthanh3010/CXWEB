<%@ Page Title="" Language="C#" MasterPageFile="~/Site_checklist.Master" AutoEventWireup="true" CodeBehind="checklist_unit_selection.aspx.cs" Inherits="CXWeb.checklist.checklist_unit_selection" %>
     ...
     <table style="width:100%; height:100%;">
            <tr style="height:26px;">
                <td style="text-align:left;">
                     <asp:Button ID="btn1" style="font-size:large;" runat="server" Text="點檢狀況 Tình huống điểm kiểm" OnClick="btn1_Click" Font-Bold="true"></asp:Button> 
    ...
    <table class='tabs' style="width: 100%; height: 120px;">
        ...
        <tbody>
            <tr>
                ...
                <td rowspan="7" style="width: 60%; vertical-align: top; border: none;">
                    <div id='tab1'>
