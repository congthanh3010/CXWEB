<%@ Page Title="Báo công CheckIn" Language="C#"  MasterPageFile="~/Site_schedule.Master"  AutoEventWireup="true" CodeBehind="FrmCheckIn.aspx.cs" Inherits="CXWeb.BaoCong.FrmCheckIn" EnableEventValidation="false" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div id="frmTitle" style="background: #006699; text-align: center;">
                                        <asp:Label ID="lblTitle" runat="server" Font-Bold="true" ForeColor="White" Text="Production CheckIn"></asp:Label>
                                    </div>
                                        ...
                                        <table class="work-log-input" style="width: 100%; padding: 0; border: 0; font-size: 22px;">
                                            <tr>
                                                ...
                                                <td class="work-log-input-col-2" colspan="2">
                                                    <asp:TextBox ID="txtRunCard" ClientIDMode="Static" runat="server" Style="text-transform: uppercase"
                                                        OnTextChanged="txtInput_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="work-log-input-col-1">2.Process/Công đoạn</td>
                                                <td class="work-log-input-col-2" colspan="2">
                                                    <asp:TextBox ID="txtProcess" ClientIDMode="Static" runat="server" Style="text-transform: uppercase"
                                                        OnTextChanged="txtInput_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td class="work-log-input-col-1">3.Machine ID/Mã máy</td>
                                                <td class="work-log-input-col-2" colspan="2">
                                                    <asp:TextBox ID="txtMachineId" runat="server" ClientIDMode="Static" Style="text-transform: uppercase"
                                                        OnTextChanged="txtInput_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td class="work-log-input-col-1"></td>
                                                <td class="work-log-input-col-2" colspan="2">
                                                    <asp:ListBox ID="albTimeLine" runat="server" AutoPostBack="true" Width="100%"
                                                        OnSelectedIndexChanged="albTimeLine_SelectedIndexChanged"></asp:ListBox>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td class="work-log-input-col-1">4.Emp ID</td>
                                                <td style="width: 80px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 80px;">
                                                    <asp:TextBox ID="txtBeginDate" runat="server" ClientIDMode="Static"></asp:TextBox>
                                                </td>
                                                <td class="work-log-input-col-2">
                                                    <asp:TextBox ID="txtBeginGio" runat="server" BackColor="#00ff99" ClientIDMode="Static"></asp:TextBox>
                                                    <cc1:MaskedEditExtender ID="meeBeginTime" runat="server" TargetControlID="txtBeginGio" MaskType="Time" Mask="99:99" />
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="work-log-input-col-2">
                                                    <asp:TextBox ID="txtEndGio" runat="server" BackColor="#00ff99" ClientIDMode="Static"></asp:TextBox>
                                                    <cc1:MaskedEditExtender ID="meeEndTime" runat="server" TargetControlID="txtEndGio" MaskType="Time" Mask="99:99" />
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <div style="width: 100%;">
                                ...
                                <div id="frmList" class="grvContainer">
                                    <asp:GridView ID="grvWLog" runat="server" CssClass="grvWLog" HorizontalAlign="Center"
                                        AutoGenerateColumns="false" BackColor="#CACBE1" ShowFooter="true" Width="1300px"
                                ...
                                <Triggers>
                                    ...
                                    <asp:PostBackTrigger ControlID="grvWLog" />
                                    <asp:AsyncPostBackTrigger ControlID="txtRunCard" EventName="TextChanged" />
                                    <asp:AsyncPostBackTrigger ControlID="txtProcess" EventName="TextChanged" />
                                    <asp:AsyncPostBackTrigger ControlID="albTimeLine" EventName="SelectedIndexChanged" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </td>
                    </tr>
