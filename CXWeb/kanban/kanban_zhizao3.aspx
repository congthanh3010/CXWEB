                        ...
                        <ContentTemplate>
                            <div style="position: absolute; width: 100%; height: 100%; overflow: auto;">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%" BackColor="#CACBE1" ShowFooter="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="客訴日期</br>Ngày khiếu nại của khách" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("客訴日期") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="料號</br>Mã liệu" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("料號") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="客訴內容</br>Nội dung khiếu nại" HeaderStyle-Width="400px">
                                            <ItemTemplate>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("客訴內容") %>' Font-Size="28px"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="責任單位</br>Đơn vị phụ trách" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("責任單位") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="設備編號</br>Mã số thiết bị" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("機台編號") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="作業員</br>Nhân viên thao tác" HeaderStyle-Width="300px">
                                            <ItemTemplate>
                                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("作業員編號") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
