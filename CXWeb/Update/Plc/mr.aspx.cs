...
namespace CXWeb.plc
{
    public partial class mr : System.Web.UI.Page
    {
        ...
        protected static string area_code= "CT2_LH";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (DateTime.Now.Minute % 11 == 0) area_code = "CT1";
                else if (DateTime.Now.Minute % 11 == 1) area_code = "CT2";
                else if (DateTime.Now.Minute % 11 == 2) area_code = "CT21";
                else if (DateTime.Now.Minute % 11 == 3) area_code = "CT2_LH";
                else if (DateTime.Now.Minute % 11 == 4) area_code = "CT3";
                else if (DateTime.Now.Minute % 11 == 5) area_code = "CT31";
                else if (DateTime.Now.Minute % 11 == 6) area_code = "CNC1";
                else if (DateTime.Now.Minute % 11 == 7) area_code = "CNC11";
                else if (DateTime.Now.Minute % 11 == 8) area_code = "CNC2";
                else if (DateTime.Now.Minute % 11 == 9) area_code = "CNC21";
                else if (DateTime.Now.Minute % 11 == 10) area_code = "NC";
                else if (DateTime.Now.Minute % 11 == 11) area_code = "NC1";
                else if (DateTime.Now.Minute % 11 == 12) area_code = "DE";
            }

            if (area_code == "CT1") head_title = "PLC數據統計分析_製一";
            else if (area_code == "CT2") head_title = "PLC數據統計分析_製二單打之一";
            else if (area_code == "CT21") head_title = "PLC數據統計分析_製二單打之二";
            else if (area_code == "CT2_LH") head_title = "PLC數據統計分析_製二連續鍛打";
            else if (area_code == "CT3") head_title = "PLC數據統計分析_製三之一";
            else if (area_code == "CT31") head_title = "PLC數據統計分析_製三之二";
            else if (area_code == "CNC1") head_title = "PLC數據統計分析_CNC第一區之一";
            else if (area_code == "CNC11") head_title = "PLC數據統計分析_CNC第一區之二";
            else if (area_code == "CNC2") head_title = "PLC數據統計分析_CNC第二區之一";
            else if (area_code == "CNC21") head_title = "PLC數據統計分析_CNC第二區之二";
            else if (area_code == "NC") head_title = "PLC數據統計分析_NC加工區之一";
            else if (area_code == "NC1") head_title = "PLC數據統計分析_NC加工區之二";
            else if (area_code == "DE") head_title = "PLC數據統計分析_鋁製區";
            ...
            if (area_code == "CT1")
            {
                ...
                machine_code[no] = "NF-32B-5S"; no += 1;
                machine_code[no] = "NF-36B-5S"; no += 1;
                machine_code[no] = "XL-200"; no += 1;
                machine_code[no] = "XL-201"; no += 1;
            ...
            else if (area_code == "CT2")
            {
                ...
                machine_code[no] = "KT-650010"; no += 1;
                ...
                machine_code[no] = "TD-065012"; no += 1;
            ...
            else if (area_code == "CT21")
            {
                ...
                machine_code[no] = "TD-650013"; no += 1;
                machine_code[no] = "TN-0201"; no += 1;
                machine_code[no] = "TN-0250"; no += 1;
                machine_code[no] = "TN-0251"; no += 1;
                machine_code[no] = "TN-0252"; no += 1;
            ...
            {
                machine_code[no] = "KT-0405"; no += 1;
                machine_code[no] = "KT-0406"; no += 1;
                machine_code[no] = "KT-0409"; no += 1;
                machine_code[no] = "KT-0410"; no += 1;
                machine_code[no] = "KT-0413"; no += 1;
                machine_code[no] = "KT-065011"; no += 1;
            ...
            else if (area_code == "CT31")
            {
                ...
                machine_code[no] = "XP-2602"; no += 1;

            }
            else if (area_code == "CNC1")
            {
                machine_code[no] = "CN-C017"; no += 1;
                machine_code[no] = "CNC-018"; no += 1;
                machine_code[no] = "CNC-019"; no += 1;
                machine_code[no] = "CNC-020"; no += 1;
                machine_code[no] = "CNC-021"; no += 1;
                machine_code[no] = "CNC-022"; no += 1;
                machine_code[no] = "CNC-035"; no += 1;
                machine_code[no] = "CNC-036"; no += 1;
                machine_code[no] = "CNC-037"; no += 1;
                machine_code[no] = "CNC-038"; no += 1;
                machine_code[no] = "CNC-039"; no += 1;
                machine_code[no] = "CNC-040"; no += 1;
                machine_code[no] = "CNC-041"; no += 1;
                machine_code[no] = "CNC-042"; no += 1;
                machine_code[no] = "CNC-043"; no += 1;
                machine_code[no] = "CNC-044"; no += 1;
                machine_code[no] = "CNC-045"; no += 1;
                machine_code[no] = "CNC-046"; no += 1;
                machine_code[no] = "CNC-047"; no += 1;
                machine_code[no] = "CNC-048"; no += 1;
                machine_code[no] = "CNC-049"; no += 1;
                machine_code[no] = "CNC-050"; no += 1;
                machine_code[no] = "CNC-051"; no += 1;
                machine_code[no] = "CNC-052"; no += 1;
                machine_code[no] = "CNC-053"; no += 1;
                 
            }
            else if (area_code == "CNC11")
            {
                machine_code[no] = "CNC-054"; no += 1;
                machine_code[no] = "CNC-055"; no += 1;
                machine_code[no] = "CNC-061"; no += 1;
                machine_code[no] = "CNC-062"; no += 1;
                machine_code[no] = "CNC-067"; no += 1;
                machine_code[no] = "CNC-068"; no += 1;
                machine_code[no] = "CNC-069"; no += 1;
                machine_code[no] = "CNC-070"; no += 1;
                machine_code[no] = "CNC-071"; no += 1;
                machine_code[no] = "CNC-072"; no += 1;
                machine_code[no] = "CNC-073"; no += 1;
                machine_code[no] = "CNC-074"; no += 1;
                machine_code[no] = "CNC-075"; no += 1;
                machine_code[no] = "CNC-076"; no += 1;
                machine_code[no] = "CNC-077"; no += 1;
                machine_code[no] = "CNC-078"; no += 1;
                machine_code[no] = "CNC-079"; no += 1;
                machine_code[no] = "CNC-080"; no += 1;
                machine_code[no] = "CNC-081"; no += 1;
                machine_code[no] = "CNC-082"; no += 1;
                machine_code[no] = "CNC-083"; no += 1;
                machine_code[no] = "CNC-084"; no += 1;
                machine_code[no] = "CNC-085"; no += 1;
                machine_code[no] = "CNC-086"; no += 1;
                machine_code[no] = "CNC-087"; no += 1;
            }

            else if (area_code == "CNC2")
            {
           
                machine_code[no] = "CNC-009"; no += 1;
                machine_code[no] = "CNC-011"; no += 1;
                machine_code[no] = "CNC-023"; no += 1;
                machine_code[no] = "CNC-024"; no += 1;
                machine_code[no] = "CNC-025"; no += 1;
                machine_code[no] = "CNC-026"; no += 1;
                machine_code[no] = "CNC-023"; no += 1;
                machine_code[no] = "CNC-027"; no += 1;
                machine_code[no] = "CNC-056"; no += 1;
                machine_code[no] = "CNC-057"; no += 1;
                machine_code[no] = "CNC-058"; no += 1;
                machine_code[no] = "CNC-059"; no += 1;
                machine_code[no] = "CNC-060"; no += 1;
                machine_code[no] = "CNC-063"; no += 1;
                machine_code[no] = "CNC-064"; no += 1;
                machine_code[no] = "CNC-065"; no += 1;
                machine_code[no] = "CNC-066"; no += 1;
                machine_code[no] = "CNC-088"; no += 1;
             
            }
            else if (area_code == "CNC21")
            {
                machine_code[no] = "CNC-089"; no += 1;
                machine_code[no] = "CNC-090"; no += 1;
                machine_code[no] = "CNC-091"; no += 1;
                machine_code[no] = "CNC-092"; no += 1;
                machine_code[no] = "CNC-093"; no += 1;
                machine_code[no] = "CNC-094"; no += 1;
                machine_code[no] = "CNC-095"; no += 1;
                machine_code[no] = "CNC-096"; no += 1;
                machine_code[no] = "CNC-097"; no += 1;
                machine_code[no] = "CNC-098"; no += 1;
                machine_code[no] = "CNC-099"; no += 1;
                machine_code[no] = "CNC-100"; no += 1;
                machine_code[no] = "CNC-101"; no += 1;
                machine_code[no] = "CNC-102"; no += 1;
                machine_code[no] = "CNC-103"; no += 1;
                machine_code[no] = "CNC-104"; no += 1;
                machine_code[no] = "CNC-105"; no += 1;
                machine_code[no] = "CNC-106"; no += 1;
                machine_code[no] = "CNC-107"; no += 1;
            }

            else if (area_code == "NC")
            {
                machine_code[no] = "CK-001"; no += 1;
                machine_code[no] = "CK-002"; no += 1;
                machine_code[no] = "CK-003"; no += 1;
                machine_code[no] = "CK-004"; no += 1;
                machine_code[no] = "CK-005"; no += 1;
                machine_code[no] = "CK-006"; no += 1;
                machine_code[no] = "CK-007"; no += 1;
                machine_code[no] = "CK-008"; no += 1;
                machine_code[no] = "CK-009"; no += 1;
                machine_code[no] = "CK-010"; no += 1;
                machine_code[no] = "CK-011"; no += 1;
                machine_code[no] = "CK-012"; no += 1;
                machine_code[no] = "CK-013"; no += 1;
                machine_code[no] = "CK-014"; no += 1;
                machine_code[no] = "CK-015"; no += 1;
                machine_code[no] = "CK-016"; no += 1;
                machine_code[no] = "CK-017"; no += 1;
                machine_code[no] = "CK-018"; no += 1;
                machine_code[no] = "CK-020"; no += 1;
                machine_code[no] = "CK-021"; no += 1;
                machine_code[no] = "CK-022"; no += 1;
                machine_code[no] = "CK-023"; no += 1;
                machine_code[no] = "CK-024"; no += 1;

            }
            else if (area_code == "NC1")
            {
              
                machine_code[no] = "CK-025"; no += 1;
                machine_code[no] = "CK-026"; no += 1;
                machine_code[no] = "CK-027"; no += 1;
                machine_code[no] = "CK-028"; no += 1;
                machine_code[no] = "CK-029"; no += 1;
                machine_code[no] = "CK-030"; no += 1;
                machine_code[no] = "CK-031"; no += 1;
                machine_code[no] = "CK-032"; no += 1;
                machine_code[no] = "CK-033"; no += 1;
                machine_code[no] = "CK-042"; no += 1;
                machine_code[no] = "CK-043"; no += 1;
                machine_code[no] = "CK-044"; no += 1;
                machine_code[no] = "CK-045"; no += 1;
                machine_code[no] = "CK-046"; no += 1;
                machine_code[no] = "CK-047"; no += 1;
                machine_code[no] = "CK-034"; no += 1;
                machine_code[no] = "CK-035"; no += 1;
                machine_code[no] = "CK-036"; no += 1;
                machine_code[no] = "CK-037"; no += 1;
                machine_code[no] = "CK-038"; no += 1;
                machine_code[no] = "CK-039"; no += 1;
                machine_code[no] = "CK-040"; no += 1;
                machine_code[no] = "CK-041"; no += 1;
        ...
        private void query()
        {
            ...
            this.Repeater1.DataSource = this.GetData(0, machine_code[0], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater1.DataBind();
            this.Repeater2.DataSource = this.GetData(1, machine_code[1], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater2.DataBind();
            this.Repeater3.DataSource = this.GetData(2, machine_code[2], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater3.DataBind();
            this.Repeater4.DataSource = this.GetData(3, machine_code[3], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater4.DataBind();
            this.Repeater5.DataSource = this.GetData(4, machine_code[4], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater5.DataBind();
            this.Repeater6.DataSource = this.GetData(5, machine_code[5], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater6.DataBind();
            this.Repeater7.DataSource = this.GetData(6, machine_code[6], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater7.DataBind();
            this.Repeater8.DataSource = this.GetData(7, machine_code[7], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater8.DataBind();
            this.Repeater9.DataSource = this.GetData(8, machine_code[8], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater9.DataBind();
            this.Repeater10.DataSource = this.GetData(9, machine_code[9], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater10.DataBind();
            this.Repeater11.DataSource = this.GetData(10, machine_code[10], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater11.DataBind();
            this.Repeater12.DataSource = this.GetData(11, machine_code[11], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater12.DataBind();
            this.Repeater13.DataSource = this.GetData(12, machine_code[12], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater13.DataBind();
            this.Repeater14.DataSource = this.GetData(13, machine_code[13], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater14.DataBind();
            this.Repeater15.DataSource = this.GetData(14, machine_code[14], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater15.DataBind();
            this.Repeater16.DataSource = this.GetData(15, machine_code[15], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater16.DataBind();
            this.Repeater17.DataSource = this.GetData(16, machine_code[16], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater17.DataBind();
            this.Repeater18.DataSource = this.GetData(17, machine_code[17], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater18.DataBind();
            this.Repeater19.DataSource = this.GetData(18, machine_code[18], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater19.DataBind();
            this.Repeater20.DataSource = this.GetData(19, machine_code[19], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater20.DataBind();
            this.Repeater21.DataSource = this.GetData(20, machine_code[20], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater21.DataBind();
            this.Repeater22.DataSource = this.GetData(21, machine_code[21], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater22.DataBind();
            this.Repeater23.DataSource = this.GetData(22, machine_code[22], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater23.DataBind();
            this.Repeater24.DataSource = this.GetData(23, machine_code[23], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
            this.Repeater24.DataBind();
            this.Repeater25.DataSource = this.GetData(24, machine_code[24], text1.ToString("yyyy-MM-dd HH:mm"), text2.ToString("yyyy-MM-dd HH:mm"));
        ...
        private void GetData_all(string pDate1, string pDate2)
        {
            ...
            dataPN_all.TableName = "dataMa_St";
        ...
        private DataTable GetData(int flag, string pMaMay, string pDate1, string pDate2)
        {
            string strsql;
            ...
            for (int i = 0; i < dataReport.Rows.Count; i++)
            {
                ...
                {
                    dataReport.Rows[i]["code"] = " class = 'black'";                    
                }
            }

            dataReport.Rows[dataReport.Rows.Count - 1]["code"] = " class = ''" + lastColour + "'";
            ...
            dataReport.Rows.Add("","", PN[flag], "style = 'width:70px; text-align: left'");
            dataReport.Rows.Add("", "", "", " class = 'black'");
            dataReport.Rows.Add("", "", Process[flag], "style = 'width:30px; text-align: left'");
            
            if (dataMa_St.Rows.Count != 0)
            {
                dataReport.Rows.Add("", "", "", " class = 'black'");
                dataReport.Rows.Add("", "", dataMa_St.Rows[0]["dStTimeStart"].ToString(), "style = 'width:50px; text-align: left'");
                dataReport.Rows.Add("", "", "", " class = 'black'");
                ...
                dataReport.Rows.Add("", "", dataMa_St.Rows[0]["cDesc"].ToString(), "style = 'width:240px; text-align: left'");
            }
            else
            {
                dataReport.Rows.Add("", "", "", " class = 'black'");
                dataReport.Rows.Add("", "", " ", "style = 'width:50px; text-align: left'");
                dataReport.Rows.Add("", "", "", " class = 'black'");
                ...
                dataReport.Rows.Add("", "", "", " class = 'none'");
                dataReport.Rows.Add("", "", "", " class = 'none'");
                dataReport.Rows.Add("", "", " ", "style = 'width:240px; text-align: left'");
            }
