                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="3" style="width: 60%; vertical-align: top; border: none;">
                                <div id='tab1'>
                                    <asp:Button ID="btnCT5" CssClass="button" runat="server" Text="製造前段看板設定" OnClick="btnCT5_Click"></asp:Button>
                                    <asp:Button ID="btnCT1" CssClass="button" runat="server" Text="製一" OnClick="btnCT1_Click"></asp:Button>
                                    <asp:Button ID="btnCT2" CssClass="button" runat="server" Text="製二" OnClick="btnCT2_Click"></asp:Button>
                                    <asp:Button ID="btnCT3" CssClass="button" runat="server" Text="製三" OnClick="btnCT3_Click"></asp:Button>
                                    <asp:Button ID="btnCT4" CssClass="button" runat="server" Text="製造後端" OnClick="btnCT4_Click"></asp:Button>
