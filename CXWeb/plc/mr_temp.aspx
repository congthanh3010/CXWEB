<%@ Page Title="" Language="C#" MasterPageFile="~/Site_plc.Master" AutoEventWireup="true" CodeBehind="mr_temp.aspx.cs" Inherits="CXWeb.plc.mr_temp" %>
                    ...
                    <tr>
                        ...
                        <td style="width: 120px; text-align: left; font-weight: bold;">
                            <asp:DropDownList Width="120px" ID="area" runat="server" AutoPostBack="true" OnSelectedIndexChanged="area_SelectedIndexChanged">
                                ...
                                <asp:ListItem Value="CT3_LH">製三組連續沖壓</asp:ListItem>
