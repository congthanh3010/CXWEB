<%@ Page Title="" Language="C#" MasterPageFile="~/Site_plc.Master" AutoEventWireup="true" CodeBehind="mr _NC.aspx.cs" Inherits="CXWeb.plc.mr" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid myreport">
        ...
        <div class="row">
            ...
            <table class=" table table-bordered table-striped" style="width: 1526px; margin-left: unset">
                ...
                <tbody>
                    <tr>
                        <th style="width: 120px; text-align: center;"><%=dateNow.ToString("yyyy/MM/dd") %></th>
                        <th colspan="32"><%=head_title%></th>
                    </tr>
                    <tr>

                        <td style="width: 120px; text-align: left; font-weight: bold;">
                            <asp:DropDownList Width="120px" ID="area" runat="server" AutoPostBack="true" OnSelectedIndexChanged="area_SelectedIndexChanged">
                        ...
                        <td style="width: 50px; text-align: left; padding-left: 15px">%</td>
                        ...
                        <td style="width: 50px; text-align: left; padding-left: 10px;">%</td>

                        <td style="width: 70px; text-align: center">PN</td>
                        <td style="width: 30px; text-align: center">pro</td>
                        <td style="width: 50px; text-align: center">Time</td>
                        <td style="width: 246px; text-align: center">Status</td>
                        <td style="width: 100px; text-align: center;">通知1</td>
                        <td style="width: 100px; text-align: center;">通知2</td>
                    </tr>
                </tbody>
            ...
            <table class=" table table-bordered table-striped table-responsive" style="width: 1526px; margin-left: unset">

                <tbody>

                    <tr <%=code_row_machine[0]%>>
                        <td style="min-width: 119px; text-align: left; padding-left: 5px;"><%=machine_code[0]%></td>
                    ...
                    <tr <%=code_row_machine[1]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px"><%=machine_code[1]%></td>
                    ...
                    <tr <%=code_row_machine[2]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px"><%=machine_code[2]%></td>
                    ...
                    <tr <%=code_row_machine[3]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[3]%></td>
                    ...
                    <tr <%=code_row_machine[4]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[4]%></td>
                    ...
                    <tr <%=code_row_machine[5]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[5]%></td>
                    ...
                    <tr <%=code_row_machine[6]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[6]%></td>
                    ...
                    <tr <%=code_row_machine[7]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[7]%></td>
                    ...
                    <tr <%=code_row_machine[8]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[8]%></td>
                    ...
                    <tr <%=code_row_machine[9]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[9]%></td>
                    ...
                    <tr <%=code_row_machine[10]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[10]%></td>
                    ...
                    <tr <%=code_row_machine[11]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[11]%></td>
                    ...
                    <tr <%=code_row_machine[12]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[12]%></td>
                    ...
                    <tr <%=code_row_machine[13]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[13]%></td>
                    ...
                    <tr <%=code_row_machine[14]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[14]%></td>
                    ...
                    <tr <%=code_row_machine[15]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[15]%></td>
                    ...
                    <tr <%=code_row_machine[16]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[16]%></td>
                    ...
                    <tr <%=code_row_machine[17]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[17]%></td>
                    ...
                    <tr <%=code_row_machine[18]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[18]%></td>
                    ...
                    <tr <%=code_row_machine[19]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[19]%></td>
                    ...
                    <tr <%=code_row_machine[20]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[20]%></td>
                    ...
                    <tr <%=code_row_machine[21]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[21]%></td>
                    ...
                    <tr <%=code_row_machine[22]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[22]%></td>
                    ...
                    <tr <%=code_row_machine[23]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[23]%></td>
                    ...
                    <tr <%=code_row_machine[24]%>>
                        <td style="width: 100px; text-align: left; padding-left: 5px;"><%=machine_code[24]%></td>
            ...
            <table class="table table-bordered table-striped table-responsive table-info" style="width: 1526px;">
                <thead>
                    <tr>
                        <th>機台狀況通知 - Thông báo tình trạng máy</th>
                    </tr>
                </thead>
                <tbody>
                    <asp:Repeater ID="Repeater26" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td style="text-align: left; padding-left: 5px;"><%# Eval("Message") %></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
