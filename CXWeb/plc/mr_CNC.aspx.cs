...
namespace CXWeb.plc
{
    public partial class mr_CNC : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dateNow.Minute % 4 == 0) area_code = "CT1";
                else if (dateNow.Minute % 4 == 1) area_code = "CT2";
                else if (dateNow.Minute % 4 == 2) area_code = "CT21";
                else if (dateNow.Minute % 4 == 3) area_code = "CT2_LH";
            }

            if (area_code == "CNC1") head_title = "PLC數據統計分析_CNC第一區之一";
