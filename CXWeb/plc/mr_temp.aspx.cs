...
namespace CXWeb.plc
{
    public partial class mr_temp : Page
    {
        ...
        {
            //dateNow = new DateTime(2020, 12, 3, 0, 1, 1);
            ...
            else
            {
                ...
                if (dateNow.Minute % 11 == 0) area_code = "CT1";
                else if (dateNow.Minute % 11 == 1) area_code = "CT2";
                else if (dateNow.Minute % 11 == 2) area_code = "CT21";
                else if (dateNow.Minute % 11 == 3) area_code = "CT2_LH";
                else if (dateNow.Minute % 11 == 4) area_code = "CT3";
                else if (dateNow.Minute % 11 == 5) area_code = "CT31";
                else if (dateNow.Minute % 11 == 6) area_code = "CNC1";
                else if (dateNow.Minute % 11 == 7) area_code = "CNC11";
                else if (dateNow.Minute % 11 == 8) area_code = "CNC2";
                else if (dateNow.Minute % 11 == 9) area_code = "CNC21";
                else if (dateNow.Minute % 11 == 10) area_code = "NC";
                else if (dateNow.Minute % 11 == 11) area_code = "NC1";
                else if (dateNow.Minute % 11 == 12) area_code = "DE";
            }
            ...
            else if (area_code == "CT3_LH") head_title = "PLC數據統計分析_製三組連續沖壓";
            ...
            else if (area_code == "JA") head_title = "PLC數據統計分析_精密沖壓";
        ...
        private void query()
        {
            ...
            try
            {
                ...
                if (dateNow.Hour < 6)
                    d--;
                text1 = new DateTime(y, m, d, 0, 0, 0);
                text2 = new DateTime(y, m, d, 0, 0, 0);
            ...
            {
                this.date.Text = dateNow.ToString("dd/MM/yyyy HH:mm");
                y = Convert.ToInt32(date.Text.Substring(6, 4));
                m = Convert.ToInt32(date.Text.Substring(3, 2));
                d = Convert.ToInt32(date.Text.Substring(0, 2));
                if (dateNow.Hour < 6)
